...
const NovaUltra = { command: ['اسم'], description: 'تغيير اسم المجموعة', elite: 'off', group: true, prv: false, lock: 'off' };
...
async function execute({ sock, msg, args }) {
    ...
    if (!newName) return reply(sock, chatId, '《✧》 أدخل الاسم الجديد للمجموعة.', msg);
    try {
        await sock.groupUpdateSubject(chatId, newName);
        await reply(sock, chatId, '✿ تم تغيير اسم المجموعة بنجاح.', msg);
