...
const NovaUltra = { command: ['وصف'], description: 'تغيير وصف المجموعة', elite: 'off', group: true, prv: false, lock: 'off' };
...
async function execute({ sock, msg, args }) {
    ...
    if (!newDesc) return reply(sock, chatId, '《✧》 أدخل الوصف الجديد للمجموعة.', msg);
    try {
        await sock.groupUpdateDescription(chatId, newDesc);
        await reply(sock, chatId, '✿ تم تغيير وصف المجموعة بنجاح.', msg);
