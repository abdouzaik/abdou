...
const NovaUltra = { command: ['غياب', 'afk'], description: 'تفعيل وضع الغياب', elite: 'off', group: false, prv: false, lock: 'off' };
...
async function execute({ sock, msg, args }) {
    ...
    const motivo = user.afkReason || 'بدون سبب!';
    return reply(sock, chatId, `ꕥ المستخدم *${user.name || 'مستخدم'}* سيكون غائباً.\n> ○ السبب » *${motivo}*`, msg);
}
